...
const AddEmployeePage: React.FC = () => {
  ...
  const formik = useFormik<IFormValues>({
    ...
    onSubmit: async (values) => {
      ...
      try {
        // Assume API endpoint is correct for the Next.js setup
  ...
  // Effect to handle Team change and reset dependent fields
  useEffect(() => {
  ...
  // Effect to handle Category change and reset dependent fields
  useEffect(() => {
    ...
    if (team && category && (structure as any)[team]) {
      ...
      if (team === "Tech" && category === "Developer") {
        ...
        setSubCategoryOptions([]);
        // Set subCategory to 'N/A' if not a Tech Developer, as per the original logic
  ...
  // Effect to handle Sub-Category change and set Department options (only for Tech Developer)
  useEffect(() => {
  ...
  const validateStep = async (step: number) => {
    ...
    // Manually set touched for fields in the current step to show errors immediately
