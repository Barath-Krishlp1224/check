  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        <button
          type="button"
          onClick={() => router.push("/components/tl-accountant/create-task")}
        ...
        <button
          type="button"
          onClick={() => router.push("/components/tl-accountant/task-view")}
          className={buttonClasses}
        >
          View All Tasks
        </button>
        ...
        <button
          type="button"
          onClick={() => router.push("/components/tl-accountant/expenses")}
          className={buttonClasses}
        >
          Expenses
        </button>
