...
export default function AdminPage() {
  ...
  // 🔹 Status logic (Late / Grace / Early Logout)
  const getStatusLabel = (record: AttendanceRecord): string => {
    ...
    if (punchInTime) {
      ...
      // 9:30–9:35 -> grace, after 9:35 -> late
      ...
      // else: on-time login (before 9:30)
    }
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
                ...
                >
                  <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-3 gap-4">
                    ...
                    <div
                      ...
                      style={{
                        transitionDelay: isQuickActionsOpen ? "300ms" : "0ms",
                      }}
                    ...
                    <div
                      ...
                      style={{
                        transitionDelay: isQuickActionsOpen ? "450ms" : "0ms",
                      }}
                    ...
                    <div
                      ...
                      style={{
                        transitionDelay: isQuickActionsOpen ? "600ms" : "0ms",
                      }}
            ...
            <div className="xl:col-span-1">
              ...
              >
                ...
                {/* Wider box */}
                <div className="bg-white rounded-xl border border-gray-200 p-4 shadow-md h-full w-full min-w-[480px]">
                  {loadingAttendance && (
