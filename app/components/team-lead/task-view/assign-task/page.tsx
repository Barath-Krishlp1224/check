  ...
  if (loading || !minLoadTimePassed) return (
    <div className="flex justify-center items-center min-h-screen bg-white">
      <div className="text-center">
        ...
        <p className="text-slate-900 font-bold uppercase tracking-widest">Syncing...</p>
      </div>
    </div>
  );
              ...
              <div className="bg-white rounded-3xl shadow-xl border border-slate-200 p-2 sticky top-32">
                {downloadFilterType === "week" ? (
                  <>
                    <div className="p-4 border-b border-slate-100">
                      <h2 className="text-[10px] font-black text-slate-800 uppercase tracking-widest flex items-center gap-2">
                        <User className="w-4 h-4 text-slate-900"/> Team Pulse
                      </h2>
                  ...
                  <>
                    <div className="p-4 border-b border-slate-100">
                      <h2 className="text-[10px] font-black text-slate-800 uppercase tracking-widest flex items-center gap-2">
                        <Info className="w-4 h-4 text-slate-900"/> Task Summary Log
                      </h2>
                      <p className="text-[9px] text-slate-700 font-bold mt-1">Snapshot of {filteredTasks.length} visible projects</p>
                    </div>
