...
export default function EmptyPage() {
  ...
  const handleEmployeeOnboard = () => router.push("/it-admin/new-emp"); 
  const handleSecondAction = () => router.push("/manager/view-list");
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-900 p-6">
      <div className="bg-white/10 backdrop-blur-lg border border-white/20 shadow-lg p-10 rounded-2xl max-w-lg w-full text-center space-y-8">
        ...
        <div className="space-y-4">
          ...
          >
            📋 View Employee List {/* change text if needed */}
          </button>
        </div>
